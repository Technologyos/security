package com.technologyos.security.configs.filters;

import com.technologyos.security.entities.JwtToken;
import com.technologyos.security.exceptions.ObjectNotFoundException;
import com.technologyos.security.repositories.JwtTokenRepository;
import com.technologyos.security.services.UserService;
import com.technologyos.security.services.auth.JwtService;
...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
   ...
   protected void doFilterInternal(HttpServletRequest request, HttpServletResponse response,
      ...
      UserDetails user = userService.findCustomersByUsername(username)
